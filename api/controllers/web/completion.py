...
class ChatApi(WebApiResource):
    def post(self, app_model, end_user):
        ...
        app_model.app_model_config.model = app_model.app_model_config.model.replace('"gpt-4"', '"gpt-4-turbo-2024-04-09"')
        # app_model.app_model_config.model = '{"provider": "openai", "name": "gpt-4-turbo-2024-04-09", "completion_params": {"max_tokens": 512, "temperature": 1, "top_p": 1, "presence_penalty": 0, "frequency_penalty": 0}}'

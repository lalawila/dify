...
class ProviderQuotaExceededError(BaseHTTPException):
    ...
    description = "Your quota for QiyeGPT Hosted Model Provider has been exhausted. " \
...
class ProviderModelCurrentlyNotSupportError(BaseHTTPException):
    ...
    description = "QiyeGPT Hosted OpenAI trial currently not support the GPT-4 model."
    code = 400

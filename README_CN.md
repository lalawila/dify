...
QiyeGPT 兼容 Langchain，这意味着我们将逐步支持多种 LLMs ，目前已支持：
...
访问 [QiyeGPT.ai](https://cloud.dify.ai)
...
- **插件**，推出符合 ChatGPT 标准的插件，或使用 QiyeGPT 产生的插件
我们将发布符合 ChatGPT 标准的插件，或者 QiyeGPT 自己的插件，以在应用程序中启用更多功能。

const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to QiyeGPT to access your team data.',
  ...
  modelName: {
    'gpt-3.5-turbo': 'AI-3.5-Turbo',
    'gpt-3.5-turbo-16k': 'AI-3.5-Turbo-16K',
    'gpt-4': 'AI-4',
    'gpt-4-32k': 'AI-4-32K',

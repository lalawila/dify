const translation = {
  ...
  welcome: 'Welcome to QiyeGPT, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting QiyeGPT Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on QiyeGPT',
  invalid: 'The link has expired',
  explore: 'Explore QiyeGPT',
